...
extern int z_impl_flash_sfdp_read(struct device * dev, off_t offset, void * data, size_t len);
static inline int flash_sfdp_read(struct device * dev, off_t offset, void * data, size_t len)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_flash_read_jedec_id(struct device * dev, uint8_t * id);
static inline int flash_read_jedec_id(struct device * dev, uint8_t * id)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
