...
extern int z_impl_peci_config(struct device * dev, uint32_t bitrate);
static inline int peci_config(struct device * dev, uint32_t bitrate)
{
...
extern int z_impl_peci_enable(struct device * dev);
static inline int peci_enable(struct device * dev)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_peci_disable(struct device * dev);
static inline int peci_disable(struct device * dev)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_peci_transfer(struct device * dev, struct peci_msg * msg);
static inline int peci_transfer(struct device * dev, struct peci_msg * msg)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
