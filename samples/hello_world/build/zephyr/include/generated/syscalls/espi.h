...
extern int z_impl_espi_read_lpc_request(struct device * dev, enum lpc_peripheral_opcode op, uint32_t * data);
static inline int espi_read_lpc_request(struct device * dev, enum lpc_peripheral_opcode op, uint32_t * data)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_espi_write_lpc_request(struct device * dev, enum lpc_peripheral_opcode op, uint32_t * data);
static inline int espi_write_lpc_request(struct device * dev, enum lpc_peripheral_opcode op, uint32_t * data)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_espi_send_vwire(struct device * dev, enum espi_vwire_signal signal, uint8_t level);
static inline int espi_send_vwire(struct device * dev, enum espi_vwire_signal signal, uint8_t level)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_espi_receive_vwire(struct device * dev, enum espi_vwire_signal signal, uint8_t * level);
static inline int espi_receive_vwire(struct device * dev, enum espi_vwire_signal signal, uint8_t * level)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
