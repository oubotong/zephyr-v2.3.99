...
extern int z_impl_entropy_get_entropy(struct device * dev, uint8_t * buffer, uint16_t length);
static inline int entropy_get_entropy(struct device * dev, uint8_t * buffer, uint16_t length)
{
