...
extern int z_impl_pwm_pin_set_cycles(struct device * dev, uint32_t pwm, uint32_t period, uint32_t pulse, pwm_flags_t flags);
static inline int pwm_pin_set_cycles(struct device * dev, uint32_t pwm, uint32_t period, uint32_t pulse, pwm_flags_t flags)
{
...
extern int z_impl_pwm_get_cycles_per_sec(struct device * dev, uint32_t pwm, uint64_t * cycles);
static inline int pwm_get_cycles_per_sec(struct device * dev, uint32_t pwm, uint64_t * cycles)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
