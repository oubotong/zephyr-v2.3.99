 ...
 *(".kernel.*")
 ...
 k_timer_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_timer_list_start = .; KEEP(*(SORT(._k_timer.static.*))); _k_timer_list_end = .; } > SRAM AT> FLASH
 k_mem_slab_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_mem_slab_list_start = .; KEEP(*(SORT(._k_mem_slab.static.*))); _k_mem_slab_list_end = .; } > SRAM AT> FLASH
 k_mem_pool_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_mem_pool_list_start = .; KEEP(*(SORT(._k_mem_pool.static.*))); _k_mem_pool_list_end = .; } > SRAM AT> FLASH
 k_heap_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_heap_list_start = .; KEEP(*(SORT(._k_heap.static.*))); _k_heap_list_end = .; } > SRAM AT> FLASH
 k_mutex_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_mutex_list_start = .; KEEP(*(SORT(._k_mutex.static.*))); _k_mutex_list_end = .; } > SRAM AT> FLASH
 k_stack_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_stack_list_start = .; KEEP(*(SORT(._k_stack.static.*))); _k_stack_list_end = .; } > SRAM AT> FLASH
 k_msgq_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_msgq_list_start = .; KEEP(*(SORT(._k_msgq.static.*))); _k_msgq_list_end = .; } > SRAM AT> FLASH
 k_mbox_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_mbox_list_start = .; KEEP(*(SORT(._k_mbox.static.*))); _k_mbox_list_end = .; } > SRAM AT> FLASH
 k_pipe_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_pipe_list_start = .; KEEP(*(SORT(._k_pipe.static.*))); _k_pipe_list_end = .; } > SRAM AT> FLASH
 k_sem_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_sem_list_start = .; KEEP(*(SORT(._k_sem.static.*))); _k_sem_list_end = .; } > SRAM AT> FLASH
 k_queue_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_queue_list_start = .; KEEP(*(SORT(._k_queue.static.*))); _k_queue_list_end = .; } > SRAM AT> FLASH
