...
extern int z_impl_counter_get_value(struct device * dev, uint32_t * ticks);
static inline int counter_get_value(struct device * dev, uint32_t * ticks)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_counter_set_channel_alarm(struct device * dev, uint8_t chan_id, const struct counter_alarm_cfg * alarm_cfg);
static inline int counter_set_channel_alarm(struct device * dev, uint8_t chan_id, const struct counter_alarm_cfg * alarm_cfg)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_counter_cancel_channel_alarm(struct device * dev, uint8_t chan_id);
static inline int counter_cancel_channel_alarm(struct device * dev, uint8_t chan_id)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_counter_set_top_value(struct device * dev, const struct counter_top_cfg * cfg);
static inline int counter_set_top_value(struct device * dev, const struct counter_top_cfg * cfg)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern uint32_t z_impl_counter_get_top_value(struct device * dev);
static inline uint32_t counter_get_top_value(struct device * dev)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern uint32_t z_impl_counter_get_max_relative_alarm(struct device * dev);
static inline uint32_t counter_get_max_relative_alarm(struct device * dev)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern int z_impl_counter_set_guard_period(struct device * dev, uint32_t ticks, uint32_t flags);
static inline int counter_set_guard_period(struct device * dev, uint32_t ticks, uint32_t flags)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
...
extern uint32_t z_impl_counter_get_guard_period(struct device * dev, uint32_t flags);
static inline uint32_t counter_get_guard_period(struct device * dev, uint32_t flags)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
